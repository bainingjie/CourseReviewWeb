...
recommendation = [{text:"神",value:0},{text:"大仏",value:1},{text:"仏",value:2},{text:"鬼",value:3},{text:"大鬼",value:4}];
evaluation = ["出席","期末試験","レポート","発表","小テスト・中間試験","テスト時の持ち込みは可能"];
credit = [{text:"履修=単位",value:0},{text:"割と楽",value:1},{text:"それなりに厳しい",value:2},{text:"諦めがつく",value:3},{text:"まだ分からない",value:4}];
